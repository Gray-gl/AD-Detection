...
dataset['train'] = AgnewsProcessor().get_train_examples("/home/public/gl/MultiDetection/PromptADDetection/openPromptLearning/Text_Classification/agnews/")
...
# In classification, you need to define your verbalizer, which is a mapping from logits on the vocabulary to the final
# label probability. Let's have a look at the verbalizer details:
# 这里需要定义一个分词器，将模型的输出转换为可读的标签
