...
parser.add_argument("--data_dir", type=str, default="/mnt/sfs_turbo/huggingface_datasets/")
# sometimes, huggingface datasets can not be automatically downloaded due
# to network issue, please refer to 0_basic.py line 15 for solutions.
