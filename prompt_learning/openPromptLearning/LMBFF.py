...
dataset = {}
sst_path = r'/home/public/gl/MultiDetection/PromptADDetection/openPromptLearning/Text_Classification/agnews/SST-2/16-shot/16-13/'
dataset['train'] = SST2Processor().get_train_examples(sst_path)
dataset['validation'] = SST2Processor().get_dev_examples(sst_path)
dataset['test'] = SST2Processor().get_test_examples(sst_path)
