...
def train_process(args):
    ...
    model_dict = {
        ...
        'roberta_mlm_pure_normal_description_100': os.path.join(args.off_line_model_dir, 'roberta_mlm_pure_normal_description_100'),
...
class TrainingArguments:
    def __init__(self):
        ...
        # self.model_name = 'roberta_mlm_pure_normal'
...
if __name__ == '__main__':
    ...
    for j in template_id:
        ...
        for training_arguments in training_arguments_list:
            ...
            # training_arguments.model_name = 'roberta_mlm_pure_normal'   # 修改对应的模型类型
            # training_arguments.model_name = 'roberta_mlm_raw_normal'   # 修改对应的模型类型
            training_arguments.model_name = 'roberta_mlm_pure_normal_description_100'   # 修改对应的模型类型
            # training_arguments.model_name = 'roberta_mlm_raw_lexical_deficits'   # 修改对应的模型类型
            # training_arguments.model_name = 'roberta_mlm_raw_reduced_content'   # 修改对应的模型类型
    ...
    for i in range(len(template_res)):
        print(f"template_id: {i}")
        print(
            f"{template_res[i][0]:.2f} {template_res[i][1]:.2f} {template_res[i][2]:.2f} {template_res[i][3]:.2f}"
        )
